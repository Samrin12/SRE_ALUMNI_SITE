...
<head>
    ...
    <!-- custom css -->
    <link rel="stylesheet" href="css/blood_register.css">
   ...
   <section class="header">
            ...
            <div class="row">
                <div class="col-md-5 ms-auto me-3 form-page text-center my-auto">
                    ...
                    <form action="" method="POST">
                        ...
                        <input type="text" name="blood" placeholder="Enter Your Blood Group" class="form-control">
    ...
    <?php
       if (isset($_POST['register']))
      {
        ...
        $query= "INSERT INTO blood (user_name,blood_group, phone_number, email,  address)
        VALUES('$name', '$blood', '$phone', '$email', '$address')";
